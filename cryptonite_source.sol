...
contract Cryptonite is Context, IBEP20, Ownable {
    ...
    string private _name     = "Cryptonite";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        if (marketingFee > 0) {
            payable(0x8eaeAca5Bfb3C176FD4DBDE0F206863271F5455a).transfer(marketingFee);
            emit MarketingFeeSent(0x8eaeAca5Bfb3C176FD4DBDE0F206863271F5455a, marketingFee);
        }
